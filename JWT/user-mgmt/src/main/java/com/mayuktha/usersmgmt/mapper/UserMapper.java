...
public class UserMapper {
	...
	public static iUser mapToUser(UserDto userDto,iUser user) {
	...
	public static UserDto mapToUserDto(iUser user,UserDto userDto) {
	...
	public static UserDto mapUserToDtoBasic(iUser user){
        UserDto userDto = new UserDto();
        userDto.setId(user.getId());
        AddressDto addeAddressDto = new AddressDto();
       if(user!=null && user.getAddress()!=null) {
    	   addeAddressDto.setMobile(user.getAddress().getMobile());
       }
