...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
	...
	protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
		...
		logger.debug("JwtAuthenticationFilter:::in products::::doFilterInternal::::::::::START");
		
		String userId = request.getHeader("X-User");
        String roles = request.getHeader("X-User-Roles");
        logger.debug("HeaderAuthenticationFilter:::::::doFilterInternal::in products::::userId::::{}",userId);
        logger.debug("HeaderAuthenticationFilter:::::::doFilterInternal:::in products:::roles::::{}",roles);
        if (userId != null) {
